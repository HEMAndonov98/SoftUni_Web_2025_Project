        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningPath_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningPathGoal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearningPathGoal_Skill_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skill",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearningPathGoal_Topic_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TopicId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    learningGoalStatus = table.Column<int>(type: "int", nullable: false),
                    DateSet = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateCompleted = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLearningGoal", x => new { x.UserId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_UserLearningGoal_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLearningGoal_Topic_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topic",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resource_Difficulty_DifficultyId",
                        column: x => x.DifficultyId,
                        principalTable: "Difficulty",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Resource_SubCategory_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningPathStep", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearningPathStep_Resource_ResourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceSkill", x => new { x.ResourceId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_ResourceSkill_Resource_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resource",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResourceSkill_Skill_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skill",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceTopic", x => new { x.ResourceId, x.TopicId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningPathGoal_SkillId",
                table: "LearningPathGoal",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningPathGoal_TopicId",
                table: "LearningPathGoal",
                column: "TopicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningPathStep_ResourceId",
                table: "LearningPathStep",
                column: "ResourceId");

            migrationBuilder.CreateIndex(
                name: "IX_Resource_DifficultyId",
                table: "Resource",
                column: "DifficultyId");

            migrationBuilder.CreateIndex(
                name: "IX_Resource_SubCategoryId",
                table: "Resource",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLearningGoal_TopicId",
